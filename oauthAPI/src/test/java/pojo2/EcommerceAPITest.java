...
public class EcommerceAPITest {
	...
	//  relaxedHTTPSValidation() -- this will help to bypass any SSl certification issues
	RequestSpecification reqLogin =  given().relaxedHTTPSValidation().log().all().spec(givenReq).body(login);
